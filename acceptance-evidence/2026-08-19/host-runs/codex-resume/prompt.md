...
Acceptance harness constraint: execute the installed Skill in this current workspace. The fixture is fully staged. Continue only through validated theme and the two anchor SVGs, then stop before final production. Persist every state transition and report the final stage plus files created; do not merely describe expected behavior.