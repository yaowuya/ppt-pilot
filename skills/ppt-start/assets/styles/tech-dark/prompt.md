...
- 色彩角色：dominant=#5B8CFF（主强调；用于标题或关键强调）；accent=#35D0BA（行动或指标；用于关键数据或行动强调）；support=#22345B（次级表面；用于次级表面或分隔）
...
- 形状语言：corner_radius=14；stroke_width=1.5
- 构图规则：card_coverage="40%-60%"；layout_family="content_driven"；primary_secondary_ratio=1.5
- 禁止母题：浅色高饱和多色块；亮白底；背景图片或纹理
