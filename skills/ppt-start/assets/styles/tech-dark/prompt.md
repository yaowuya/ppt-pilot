...
你的任务是基于叙事要点与内容素材，自主设计一页布局合理、视觉专业、可直接用于演示文稿的 Office-safe SVG。
...
- **深色科技**：深底 #0B1020，表面 #151D33，文字 #F4F7FF，主导高亮 #5B8CFF，强调 #35D0BA；高对比、通透科技感。
- **排版**：Arial / Microsoft YaHei / PingFang SC；标题 40+、正文 20+、脚注 14+；外部边距 64px、24px 节奏、卡片内边距 24px；圆角 14、描边 1.5。
- **构图**：内容驱动，深底冷色高亮；禁浅色高饱和多色块、亮白底、背景照片。
