...
生成器不得重新选择故事板叙事逻辑，也不得改变数字、单位、期间、限定词、因果与来源映射。它可以对显示素材提纯、改写、重排与补充；补充仅限已批准研究或来源，无事实内容的过渡句可自由撰写。在主题软风格基线（来自 `tokens.json.prompt_baseline`，由 `StyleBaselineCompiler` 投影）内，生成器可以自主选择或重选布局、层级、卡片组织、信息密度、配色用法与装饰，但必须保持整套 deck 的风格一致性。
